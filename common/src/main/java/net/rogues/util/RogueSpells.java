...
public class RogueSpells {
    ...
    private static Entry slice_and_dice() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "slice_and_dice");
    ...
    private static Entry shock_powder() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "shock_powder");
    ...
    private static Entry shadow_step() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "shadow_step");
    ...
    private static Entry vanish() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "vanish");
        var title = "Vanish";
    ...
    private static Entry bear_trap() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "bear_trap");
        var title = "Bear Trap";
    ...
    private static Entry mutilate() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "mutilate");
        var title = "Mutilate";
...
//        attack.additional_strike_delay = 0.15F;
    ...
    private static Entry warrior_throw() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "throw");
    ...
    private static Entry throw_net() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "throw_net");
        var title = "Throw Net";
        ...
        var model = SpellBuilder.ProjectileModels.model(
                Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "spell_projectile/throw_net").toString(),
    ...
    private static Entry charge() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "charge");
        var title = "Charge";
    ...
    private static Entry shout() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "shout");
    ...
    private static Entry last_stand() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "last_stand");
    ...
    private static Entry mortal_strike() {
        var id = Identifier.fromNamespaceAndPath(RoguesMod.NAMESPACE, "mortal_strike");
