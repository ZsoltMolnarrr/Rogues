...
public class BearTrapEntity extends SpellCloud {
    ...
    public BearTrapEntity(EntityType<? extends SpellCloud> entityType, Level world) {
    ...
    public boolean isSprung() {
        return getEntityData().get(SPRUNG);
    }

    @Override
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        super.defineSynchedData(builder);
        builder.define(SPRUNG, false);
    }
