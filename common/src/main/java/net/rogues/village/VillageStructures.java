...
/// injector stays null and the barracks are only placed through the data-driven paths that ship in
/// `resources/data/rogues` (Repurposed Structures pool additions, Lithostitched worldgen modifiers).
